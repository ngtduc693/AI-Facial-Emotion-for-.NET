...
public class EmotionAnalyzer
{
    ...
    {
        _faceDetector = new InferenceSession(LoadEmbeddedResource("AI.Facial.Emotion.Resources.detection.onnx"));
        _emotionModel = new InferenceSession(LoadEmbeddedResource("AI.Facial.Emotion.Resources.emotion.onnx"));
    }
